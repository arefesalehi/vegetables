    ...
    <div className="mt-40 mb-40     ">
      {
        ...
        wishes.map((wish) => {
          return (
            <div key={wish._id} className=" h-auto md:h-[142px] w-full flex-col md:flex-row  border-solid border-[1px] mb-5 flex justify-between items-center border-gray-300 hover:shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px]  rounded-[10px]">
              <div className="w-1/2 flex flex-col md:flex-row justify-center md:justify-start   p-5 items-center  ">
                <div onClick={() => removeProduct(wish.product._id)} className="w-[35px] h-[35px]   p-[12px]  md:ml-20 hover:bg-[#01512c] hover:text-white rounded-[50%] flex justify-center items-center bg-[#ececec] ">
                  <FaTrashAlt />
                </div>
              ...
              <div className=" w-1/2  justify-start p-5  items-center">
                ...
                <span className='flex justify-center items-center'>
                  ...
                  <p className=" w-[60px] md:w-[100px] md:ml-10 text-sm lg:text-xl  text-[#9bb991] flex justify-center items-center">
                    {wish.product.count === 0 ? "ناموجود" : wish.product.count}
                    <span className='text-sm lg:text-xl  '>{wish.product.count !== 0 && 'عدد در انبار'}</span>
                  </p>
                </span>

                  <button
                    type=""
                    className=" mt-3 text-sm lg:text-xl text-white bg-[#01512c] p-5 pr-10 pl-10 rounded-[30px]"
