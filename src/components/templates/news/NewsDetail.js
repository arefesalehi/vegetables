...
const newsDetail = ({newses}) => {
  return (
    <>
      <div className="w-[80%] m-auto flex">
        <div className="lg:w-1/3 md:w-0  ">
          <div className="w-[349px] hidden lg:block  lg:w-[80%] h-[489px] bg-[#f2f2f2] rounded-[30px]">
            <NewsCategory />
            <NewsSearch />
            <div className="w-full h-[654px] bg-white border border-gray-200 mt-10 rounded-[30px]">
              <h1 className="text-xl font-bold p-10 ">جدیدترین مطالب</h1>
              <NewsBox />
              <NewsBox />
              <NewsBox />
              <NewsBox />
      ...
      <Image
        ...
        height={568}
          alt='pic'
      />
      <div className="absolute bottom-50 flex flex-wrap   bottom-[-65%]">
        <span className="pt-5 pb-5 ml-5 pr-8 pl-8 mb-2 mr-3 bg-[#fffeff] hover:bg-[#007a4a] hover:text-white rounded-[30px]">
          تغذیه
        </span>
        <span className="pt-5 pb-5 ml-5 pr-8 pl-8 mb-2 bg-[#fffeff]  hover:bg-[#007a4a] hover:text-white rounded-[30px]">
          دستور پخت
        </span>
        <span className="pt-5 pb-5 ml-5 pr-8 pl-8 mb-2 bg-[#fffeff]  hover:bg-[#007a4a] hover:text-white rounded-[30px]">
          نگهداری غذا
      ...
      <div className="text-xl text-gray-600 text-justify">
        ...
        <div className="flex items-center  mb-10 text-gray-500 ">
          <span className="flex items-center  ">
            <IoMdPerson />
            <p className="mr-2">توسط {newses.author} </p>
          </span>
          <span className="flex items-center">
            <IoCalendarSharp />
            <p className="mr-2">{newses.date} </p>
          </span>
        </div>
      ...
      <div className="flex w-full justify-center  sm:justify-start items-center h-[100px]  mb-20">
        <IoMdPricetags />
        <p>
