...
const isAdmin = pathname.startsWith("/p-admin");
  ...
  return (
  //   <div className={`w-[95%] flex justify-center m-auto  ${(!isAdmin && fixTop) && "fixed top-0  w-full   z-50 shadow " }`}>
  ...
  {(!isAdmin && fixTop) && (
  <div className="w-[95%] flex justify-center m-auto fixed top-0  z-50 shadow">
    <div className={`lg:w-[95%] xl:w-[80%] w-full sm:w-[80%] m-auto sm:rounded-b-[40px] z-10 absolute ${fixTop ? "h-[70px] sm:h-[80px]" : "h-[70px] sm:h-[100px]"} flex justify-between items-center bg-white sm:bg-black transition-all duration-300`}>
        ...
        <ul className={`items-center flex flex-col bg-[#85b130] lg:bg-black md:justify-between fixed top-0 bottom-0 ${isMenuOpen ? 'right-0' : 'right-[-300px]'} transition-all duration-300 pt-[5%] w-[300px] lg:pt-0 lg:static lg:flex lg:flex-row lg:w-full lg:mt-0 lg:mr-0`}>
          ...
          {!isLogin ? (
            ...
            <li className="p-4 flex flex-col items-center cursor-pointer relative group">
              ...
              <div className="absolute top-[73px] w-[240px] h-auto justify-end flex flex-col text-right mt-2 p-3 bg-white opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-50 shadow-lg rounded-lg">

                <Link className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" href="/p-user/orders">
                  سفارشات
                </Link>

                <Link className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" href="/p-user/tickets">
                  تیکت‌های پشتیبانی
                </Link>

                <Link className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" href="/p-user/comments">
                  کامنت‌ها
                </Link>

                <Link className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" href="/p-user/wishlists">
                  علاقه‌مندی‌ها
                </Link>

                <Link className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" href="/p-user/accountDetail">
                  جزئیات اکانت
                </Link>

                <p className="mb-2 p-2 hover:text-green-700 rounded-[10px] hover:bg-gray-100" onClick={logOut}>
                  خروج
                </p>
