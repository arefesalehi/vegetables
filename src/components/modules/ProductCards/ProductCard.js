...
import ShoppingMenue from '../shoppingMenu/ShoppingMenue'
...
const ProductCard = ({ img, name, price, _id, count, score , user }) => {
  ...
  //           <p style='font-size: 17px;margin-top: 10px;color: darkgreen; '><span style='display:flex ;align-items: center;'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="green" viewBox="0 0 24 24">
  //           <path d="M12 2.25a9.75 9.75 0 1 1 0 19.5 9.75 9.75 0 0 1 0-19.5Zm0 1.5a8.25 8.25 0 1 0 0 16.5 8.25 8.25 0 0 0 0-16.5Zm3.472 5.53a.75.75 0 0 1 .073.976l-.073.085-4.243 4.242a.75.75 0 0 1-.976.073l-.085-.073-2.121-2.121a.75.75 0 0 1 .976-1.133l.085.073 1.59 1.59 3.712-3.712a.75.75 0 0 1 1.082 0Z"/></svg> ${count} عدد در انبار</span></p>
  ...
  //           </div>
  //         <a href='/checkout'><button style='width:373px; padding: 15px;background: darkgreen;border-radius: 20px;margin-top: 20px;color: white; ' >خرید کنید</button></a>
  //       </div>
  //     </div>
  //   `,
  //     showCloseButton: true,
  //     showConfirmButton: true,
  //     // confirmButtonText: 'خرید کنید',
  //     customClass: {
  //       popup: styles.customPopup,
  //     },
  //     width: '970px',  // تعیین عرض مودال
  //   });
  // }
  ...
  //     })
  //   } else {
  //     cart.push({ id: _id, name, price, counter ,img })
  //   }
    ...
    <div className=' '>
      <div className="relative  shadow-[0_3px_8px_rgba(0,0,0,0.24)] group w-[95%] h-[465px] border mb-10 p-3 ml-5 bg-white border-gray-200 rounded-[30px] transition-all duration-300">
        ...
        <div className=''>
          ...
          {/* {
            count === 0 && (<span className="absolute top-[20px] xl:left-[200px] left-[390px] cursor-pointer bg-[#d5ff6f]  pr-5 pl-5 pt-1 pb-1 rounded-[10px] ">ناموجود</span>
            )
          } */}
 {
  count === 0 && (
